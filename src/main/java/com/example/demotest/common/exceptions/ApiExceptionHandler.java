...
public class ApiExceptionHandler {
  ...
  public ErrorMessage badRequest(HttpServletRequest request, MethodArgumentNotValidException exception) {
    ...
    return new ErrorMessage(exception.getClass().getSimpleName(), exception.getMessage(), request.getRequestURI(),
        errors);
  }
  ...
  public ErrorMessage handleException(      HttpServletRequest request, Exception exception) {
